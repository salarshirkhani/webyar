        ...
        <form style="padding:10px;" action="{{ route('dashboard.admin.task.updatetask', $post->id) }}" method="post" role="form" class="form-horizontal " enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input id="date1" name="finish_date" value="{{ $post->finish_date }}" type="date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask="">
                </div>
                <!-- /.input group -->
            </div>  
