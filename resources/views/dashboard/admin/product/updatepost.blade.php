...
@endif
    <div class="col-md-12">
        ...
        <form style="padding:10px;" action="{{ route('dashboard.admin.product.updateproduct', $post->id) }}" method="post" role="form" class="form-horizontal " enctype="multipart/form-data">
            ...
            <input type="text" style="padding:10px; margin: 10px 0px 16px 0px; height: 40px; border-radius: 7px; font-size: 16px;"class="form-control" value="{{ $post->price }}" name="price"  placeholder="قیمت">
