...
<x-sidebar-item title="مدیریت دسته‌بندی ها" icon="fas fa-stream" route="dashboard.admin.category.index" />
<x-sidebar-item title="مدیریت محصولات" icon="fas fa-shopping-cart" route="dashboard.admin.product.index" />
<x-sidebar-item title="مدیریت سفارشات" icon="fas fa-list" route="dashboard.admin.order.index" />
<x-sidebar-item title="پشتیبانی" icon="fas fa-headset" route="dashboard.admin.ticket.index" />
