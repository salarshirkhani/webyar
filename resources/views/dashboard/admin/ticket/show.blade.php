...
@section('hierarchy')
    ...
    <x-breadcrumb-item title="مشاهده درخواست پشتیبانی" route="dashboard.admin.ticket.show"/>
@endsection
@section('content')
    @if(Session::has('info'))
        <div class="row">
    ...
    <div class="col-md-12">
        <x-card>
            ...
            <x-card-footer>
                <a href="{{ route('dashboard.admin.ticket.edit', compact('ticket')) }}" class="btn btn-success">ارسال پاسخ</a>
            </x-card-footer>
        </x-card>
    </div>
@endsection
