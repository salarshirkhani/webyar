...
@section('hierarchy')
    ...
    <x-breadcrumb-item title="مدیریت تسک ها" route="dashboard.admin.phase.tasks" />
@endsection
@section('content')
    @if(Session::has('info'))
    <div class="row">
...
<div class="col-md-12">
    <x-card type="info">
        <x-card-header>ساخت تسک برای فاز {{$phase->title}}</x-card-header>
    ...
    <div class="col-md-12">
        <x-card type="info">
            <x-card-header>مدیریت تسک های {{$phase->title}}</x-card-header>
                <x-card-body>
                    <div class="box-body">
