...
@section('hierarchy')
    ...
    <x-breadcrumb-item title="ارسال پاسخ" route="dashboard.customer.ticket.edit"/>
@endsection
@section('content')
    @if(Session::has('info'))
        <div class="row">
    ...
    <div class="col-md-12">
        <x-card type="info">
            <form style="padding:10px;" action="{{ route('dashboard.customer.ticket.update', compact('ticket')) }}" method="post"
