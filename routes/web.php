    ...
    ->group(function() {
        ...
        Route::prefix('admin')
            ...
            ->group(function() {
               ...
               //MESSAGE PAGE
                Route::post('message/answer/{message}', ['uses' => 'MessageController@AnswerMessage','as' => 'message.answer']);
                Route::get('message/answer/{message}', ['uses' => 'MessageController@GetAnswerMessage','as' => 'message.answer']);
